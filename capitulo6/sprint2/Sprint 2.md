...
- [6.2.2. Sprint 2](#622-sprint-2)
  ...
  - [6.2.2.7. Services Documentation Evidence for Sprint Review](#6227-software-deployment-evidence-for-sprint-review)
...
| Sprint 2 Review            | Se desplego correctamente el Landing Page, nuestra Web Application y Mobile Application. Además, se integró una solución IoT a nuestros proyectos. Como grupo opinamos que se la información detallada es adecuada, sin embargo, existen mejoras por implementar.                                                                                                                     |
| Sprint 2 Retrospective     | Como equipo tenemos los aciertos de haber desplegado el landing page, la información brindada es precisa, las secciones están correctamente distribuidas, En cuanto a la forma de trabajo, ha sido una experiencia totalmente colaborativa que ha dado buenos resultados, sin embargo, consideramos mejorar en el aspecto de la confianza para una mejor interacción de los miembros. |
| Sprint Goal & User Stories |                                                                                                                                                                                                                                                                                                                                                                                       |
| Sprint 3 Goal              | Realizar últimos detalles del funcionamiento de la solución IoT integrada a nuestras aplicaciones.                                                                                                                                                                                                                                                                                    |
...
<tr><td valign="top">TK14</td><td valign="top">Desarrollo del código Back-end</td><td valign="top">Desarrollo de las clases necesarias y divisiones</td><td valign="top">4 hours</td><td valign="top">Valery</td><td valign="top">To-do</td></tr>
...
<tr><td valign="top">TK39</td><td valign="top">Desarrollo del código Front-end</td><td valign="top">Desarrollo de los componentes y páginas.</td><td valign="top">4 hours</td><td valign="top">William</td><td valign="top">Done</td></tr>
...
<tr><td valign="top"><b>US21</b></td><td valign="top">Un asistente ubica a otro</td><td valign="top">TK74</td><td valign="top">Desarrollo de la interfaz grafica </td><td valign="top">Desarrollo de los componentes y páginas.</td><td valign="top">4 hours</td><td valign="top">Rodrigo</td><td valign="top">In progress</td></tr>
<tr><td valign="top"><b>US20</b></td><td valign="top">Atención en casos de emergencia</td><td valign="top">TK75</td><td valign="top">Desarrollo de interfaz gráfica</td><td valign="top">Desarrollo de los componentes y páginas</td><td valign="top">4 hours</td><td valign="top">Rodrigo</td><td valign="top">In progress</td></tr>
</table>
...
| **TS01**      | Acceder a Enpoints                              | TK01 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 6 hours           |William| Done                                         |
| **TS02**      | Registrar Asistentes                            | TK02 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 6 hours           |Valery| Done                                         |
| **TS03**      | Registrar Organizadores                         | TK03 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 6 hours           |Isabella | Done                                         |
| **TS04**      | Registrar Pago                                  | TK04 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 6 hours           |Rodrigo| Done                                         |
| **TS05**      | Registrar Eventos                               | TK05 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 6 hours           |Fabricio| Done                                         |
| **TS06**      | Creación de persistencia de la entidad Organizer| TK06 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 4 hours           |William| Done                                         |
| **TS07**      | Creación de persistencia de la entidad Attendee | TK07 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 4 hours           |Valery| Done                                         |
| **TS08**      | Creación de persistencia de la entidad Payment  | TK08 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 4 hours           |Isabella | Done                                         |
| **TS09**      | Creación de persistencia de la entidad Event    | TK09 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 4 hours           |Rodrigo| Done                                         |
| **TS10**      | Creación de resource de la entidad Organizer    | TK10 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 4 hours           |Fabricio| Done                                         |
| **TS11**      | Creación de resource de la entidad Payment      | TK11 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 4 hours        |William| Done                                         |
| **TS12**      | Creación de resource de la entidad Attendee     | TK12 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 4 hours        |Valery| Done                                         |
| **TS13**      | Creación de resource de la entidad Event        | TK13 |Desarrollo del código Back-end| Desarrollo de las clases necesarias y divisiones | 4 hours        |Isabella | Done                                         |

#### 6.2.2.3. Development Evidence for Sprint Review

En esta sección mostramos los commits realizados durante el desarrollo del proyecto. Para este Sprint 2 se realizaron mejoras en el front-end de nuestra aplicación, dos integrantes del equipo se encargaron de esta actualización. 

|**Repository**|**Branch**|**Commit Id**|**Commit**|**Commited**|
| - | - | - | - | - |
|CrackeletsGroupIoT/the-big-fun-web-application|Feature/corrections|544f605bb4e8638b924c619d57ba80f33832706c|feat: updated endpoints. Create relation payment with event-atendee|2/6/2024|
|CrackeletsGroupIoT/the-big-fun-web-application|Feature/corrections|309bcbbe120ff88ea9d7340d022b21fb77f3299d|feat: created payment and upload qr|29/5/2024|
|CrackeletsGroupIoT/the-big-fun-web-application|Feature/corrections|76ef6c36900c147cb06de69aab40a6c5fe40fdd0|feat: created qr for payment|27/5/24|
|CrackeletsGroupIoT/the-big-fun-web-application|Feature/corrections|8cfee363f3e8cf65ed18814f4f077522fb9f9618|feat: implemented paymentconfirmation-content, only interface|26/5/24|
|CrackeletsGroupIoT/the-big-fun-web-application|Feature/corrections|20a26f530ffd9c0787df18126298725816eae2c2|feat: implemented buy-tickets-content.component|26/5/24|
|CrackeletsGroupIoT/the-big-fun-web-application|Feature/corrections|cb9c9162d73672bd8576dbb372f35e785285ce23|feat: change index for event in eventdetails-component.component. Get correctly attendeeId in event\_service. View buy-tickets-content.component|25/5/24|
|CrackeletsGroupIoT/the-big-fun-web-application|Feature/corrections|b05b562cfe025aa4717a5c740b844c75f62a9d7e|fix: add "Cargando" in home|25/5/24|
...
*Attendees:* Para esta entidad se desarrollaron las siguientes operaciones para el CRUD.
